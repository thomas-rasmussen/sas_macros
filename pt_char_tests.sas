...
%pt_char;
%pt_char(in_ds = __data1);
%pt_char(in_ds = __data1, out_ds = __out1);
...
%pt_char(in_ds = __data1, out_ds = __out1, var_list  = bin_var __bin_var);
%pt_char(in_ds = __data1, out_ds = __out1, var_list  = bin_var, strata = __bin_var);
%pt_char(in_ds = __data1, out_ds = __out1, var_list  = bin_var, by = __bin_var);
%pt_char(in_ds = __data1, out_ds = __out1, var_list  = bin_var, weight = __bin_var);
...
%pt_char(
  in_ds     = __test.__data1, 
  out_ds    = __test.__out1, 
  var_list  = bin_var
  );
...
correctly specified. */
%pt_char(in_ds = abcd, out_ds = __out1, var_list  = bin_var);
%pt_char(in_ds = 1abcd, out_ds = __out1, var_list  = bin_var );
%pt_char(in_ds = notlib.abcd, out_ds = _out1, var_list  = bin_var);
%pt_char(in_ds = "abcd", out_ds = __out1, var_list = bin_var);


/*** Test "var_list" macro parameter ***/
%pt_char(in_ds = __data1, out_ds = __out1, var_list = bin_var);
%pt_char(in_ds = __data1, out_ds = __out1, var_list = bin_var$cont_var);
%pt_char(in_ds = __data1, out_ds = __out1, var_list = bin_var var_not_in_data);
%pt_char(in_ds = __data1, out_ds = __out1, var_list = bin_var bin_var);
%pt_char(in_ds = __data1, out_ds = __out1, var_list = var_max_sas_name_length_01234567);
%pt_char(in_ds = __data1, out_ds = __out1, var_list = by_char);


/*** Test "by" macro parameter ***/
%pt_char(in_ds = __data1, out_ds = __out1, var_list = bin_var, by = by_num);
%pt_char(in_ds = __data1, out_ds = __out1, var_list = bin_var, by = by_char);
%pt_char(in_ds = __data1, out_ds = __out1, var_list = bin_var, by = by_num by_char);
%pt_char(in_ds = __data1, out_ds = __out1, var_list = bin_var, by = not_var);
%pt_char(in_ds = __data1, out_ds = __out1, var_list = bin_var, by = by_num, strata = by_num);
%pt_char(in_ds = __data1, out_ds = __out1, var_list = bin_var, by = by_max_sas_name_length_012345678);
%pt_char(in_ds = __data1, out_ds = __out1, var_list = bin_var, by = null);


/*** Test "strata" macro parameter ***/
%pt_char(in_ds = __data1, out_ds = __out1, var_list = bin_var, strata = strata_num);
%pt_char(in_ds = __data1, out_ds = __out1, var_list = bin_var, strata = strata_char);
%pt_char(in_ds = __data1, out_ds = __out1, var_list = bin_var, strata = strata_num_miss);
%pt_char(in_ds = __data1, out_ds = __out1, var_list = bin_var, strata = strata_char_miss);
%pt_char(in_ds = __data1, out_ds = __out1, var_list = bin_var, strata = not_var);
...
%pt_char(in_ds = __data1, out_ds = __out1, var_list = bin_var, weight = weight_num);
%pt_char(in_ds = __data1, out_ds = __out1, var_list = bin_var, weight = weight_char);
%pt_char(in_ds = __data1, out_ds = __out1, var_list = bin_var, weight = weight_neg);
%pt_char(in_ds = __data1, out_ds = __out1, var_list = bin_var, weight = weight_num weight num);
%pt_char(in_ds = __data1, out_ds = __out1, var_list = bin_var, weight = weight_miss);
...
parameters ***/
%pt_char(in_ds = __data1, out_ds = __out1, var_list = cont_var, decimals_cont = 0);
%pt_char(in_ds = __data1, out_ds = __out1, var_list = cont_var, decimals_cont = 2.5);
%pt_char(in_ds = __data1, out_ds = __out1, var_list = bin_var, decimals_d = 2);
%pt_char(in_ds = __data1, out_ds = __out1, var_list = bin_var, decimals_d = 2.5);
%pt_char(in_ds = __data1, out_ds = __out1, var_list = bin_var, decimals_pct = 0);
%pt_char(in_ds = __data1, out_ds = __out1, var_list = bin_var, decimals_pct = 2.5);


/*** Test "decimal_mark" and "big_mark" macro parameters ***/
%pt_char(in_ds = __data1, out_ds = __out1, var_list = bin_var, decimal_mark = comma);
%pt_char(in_ds = __data1, out_ds = __out1, var_list = bin_var, decimal_mark = space);
%pt_char(in_ds = __data1, out_ds = __out1, var_list = bin_var, decimal_mark = invalid);
%pt_char(in_ds = __data1, out_ds = __out1, var_list = bin_var, big_mark = point);
%pt_char(in_ds = __data1, out_ds = __out1, var_list = bin_var, big_mark = space);
%pt_char(in_ds = __data1, out_ds = __out1, var_list = bin_var, big_mark = remove);
%pt_char(in_ds = __data1, out_ds = __out1, var_list = bin_var, big_mark = invalid);
...
%pt_char(in_ds = __data1, out_ds = __out1, var_list = bin_var, print = y);
%pt_char(in_ds = __data1, out_ds = __out1, var_list = bin_var, print = invalid);
%pt_char(in_ds = __data1, out_ds = __out1, var_list = bin_var, del = n);
%pt_char(in_ds = __data1, out_ds = __out1, var_list = bin_var, del = invalid);
